...
public class H3Ej1otraSolucion {
    public static void main(String[] args) {
        ...
        int posicion1 = (num % 10);
        int posicion2 = ((num/10) % 10);
        int posicion3 = ((num/100) % 10);

        if ((posicion3 * posicion3 * posicion3) + (posicion2 * posicion2 * posicion2) + (posicion1 * posicion1 * posicion1) == num) {
